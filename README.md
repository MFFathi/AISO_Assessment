...
**`Genetic Algorithm TSP.ipynb`**
- Complete implementation of the Genetic Algorithm for TSP
- Includes population initialization, selection, crossover, and mutation operators
- Runs experiments on 10, 20, 30, 40, and 50 city problems
- Visualizes convergence, routes, and performance metrics
- Generates results exported to `GA TSP RESULTS.csv`

**`Simulated Annealing TSP.ipynb`**
- Complete implementation of Simulated Annealing for TSP
- Includes temperature scheduling, neighbor generation, and acceptance criteria
- Runs experiments on 10, 20, 30, 40, and 50 city problems
- Visualizes temperature decay, route evolution, and acceptance rates
- Generates results exported to `SA TSP RESULTS.csv`

**`Comparison.ipynb`**
- Comprehensive comparative analysis between GA and SA
- Loads results from both CSV files
- Generates side-by-side performance comparisons
- Includes statistical analysis, visualization plots, and detailed interpretations
- Contains the final "Results and Discussion" section with time complexity analysis

### Data Files

**`cities.csv`**
- Dataset containing 50 cities with X, Y coordinates
- Format: `City, X, Y` (e.g., City_1, 37.45, 95.07)
- Coordinate range: [0, 100]
- Used as the source for all experiments (subsets extracted for different problem sizes)

**`GA TSP RESULTS.csv`**
- Structured results from Genetic Algorithm experiments
- Contains: starting city, number of cities, final distance, execution time
- Includes metrics: initial distance, improvement percentage, convergence generation
- Generated by running `Genetic Algorithm TSP.ipynb`

**`SA TSP RESULTS.csv`**
- Structured results from Simulated Annealing experiments
- Contains: starting city, number of cities, final distance, execution time
- Includes metrics: initial distance, improvement percentage, acceptance rates
- Generated by running `Simulated Annealing TSP.ipynb`

### Analysis and Results Files

**`Full Results GA.ipynb`**
- Detailed analysis of Genetic Algorithm performance
- Includes in-depth convergence analysis across different problem sizes
- Shows population diversity evolution and fitness progression
- Contains detailed visualizations of best tour routes

**`Full Results for SA.ipynb`**
- Detailed analysis of Simulated Annealing performance
- Includes temperature schedule analysis and acceptance probability tracking
- Shows solution quality evolution over iterations
- Contains detailed visualizations of optimal routes found

### Archive Files

**`Genetic Algorithm old.ipynb`**
- Previous versions and experimental implementations of GA
- Contains alternative selection methods, crossover operators, and parameter tuning experiments
- Kept for reference and comparison purposes

**`simulated annealing old algs.ipynb`**
- Previous versions and experimental implementations of SA
- Contains alternative cooling schedules, neighborhood structures, and acceptance criteria
- Kept for reference and comparison purposes

**`Unusued Algorithms.ipynb`**
- Experimental approaches that were tested but not included in final analysis
- May include hybrid methods, alternative metaheuristics, or incomplete implementations
- Kept for documentation of exploration process
